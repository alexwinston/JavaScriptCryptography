...
// pt.push("6. THESE WHO ARE MANY THEREAREANUMBEROFDIFFERENTWAYS A WRITER: CANUSE AN UNUSUALSENTENCEFORINSPIRATION.")
...
// const pt = []
// pt.push("AHESTARTBYTHINKINGSOMETHINGINANDYOURWORSTVISITINGTHISANDGODOWNFORGODKNOWSTHESEARCHFORKNOWLEDGEISPOWERTECH")
// pt.push("CHESTARTBYTHINKINGSOMETHINGATFORYOURFIRSTVISITINGTHISPATHANDYOUAREMOSTLIKELYSEARCHFORKNOWLEDGEANEEDLEINHAYSTACK")
// pt.push("EHESTARTBYTHINKINGSOMETHING IFSOMETIMES A RANDOMWORDJUSTISNTENOUGHANDTHATISWHERE THE MEDITATIONCUBE COMES INTO PLAY AFTER ALL. I WISH")
// pt.push("IHETHEIRAREMANYPRODUCING RANDOMSENTENCESCANBEHELPFUL IN A NUMBEROFDIFFERENT WAYS. OOXYLOPHONE WHI KNOWS THE SOLUTION WILL BE")
// pt.push("MHETHENGOONEFOR WRITERS,ARANDOM SENTENCE CAN HELP THEM GET THEIR CREATIVEJUICESFLOWING!EXTRA,NEXT NOITA THIS IS ALL A TERRIBLE JOKE AND WE WILL NEVER SOLVE IT")
// pt.push("PHETHENWHOARE MANY THEREAREANUMBEROFDIFFERENTWAYS A WRITER: CANUSE AN UNUSUALSENTENCEFORINSPIRATION. NOITA IS THE BANE OF OUR EXISTENCE")
// pt.push("QHETHENGOPRAYING ARETHOSEWRITERSMUCH MORECANDIFFICULTCHALLENGEISTOUSE ITTOENDASTORY QUIXOTIC ZEEBRA ZINCOXIDECRYPTOGRAPHY")
// pt.push("THETHENGOPRAYING FORGODSONLYTHOSEWRITERSWHOHAVEWRITERSBLOCK,THISCANBE AN EXCELLENT WAY TOTAKE AMASTERTOCRUMBLING THOSE WALLS.")
// pt.push("XHETHENGOPRAYING NOWTHOSEWRITERS ARE MORECANALSOSPURACHALLENGEINTHEOTHERTYPES;OFPROJECTSBEINGDONE!RATTY$MASTERA WALLS")
